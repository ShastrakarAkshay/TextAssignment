...
let EmployeeDetailsComponent = class EmployeeDetailsComponent {
    constructor(router, empService, route) {
        this.router = router;
...
let EmployeeListComponent = class EmployeeListComponent {
    constructor(empService, router, tostr, firestore, spinner) {
        this.empService = empService;
        this.router = router;
        this.tostr = tostr;
...
let EmployeeResumeComponent = class EmployeeResumeComponent {
    constructor(routes) {
        this.routes = routes;
...
EmployeeResumeComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
];
...
let HomeComponent = class HomeComponent {
    constructor(snackBar, empService, router) {
...
let NavbarComponent = class NavbarComponent {
    constructor(dialog, router, empService) {
        this.dialog = dialog;
        this.router = router;
        this.empService = empService;
        this.isLogin = false;
...
let LoginDialog = class LoginDialog {
    constructor(empService, router, dialogRef, data) {
        this.empService = empService;
        this.router = router;
...
let LogoutDialog = class LogoutDialog {
    constructor(empService, router, dialogRef, data) {
        this.empService = empService;
        this.router = router;
        this.dialogRef = dialogRef;
